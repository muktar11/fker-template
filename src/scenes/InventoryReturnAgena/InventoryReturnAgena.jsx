...
const InventoryReturnAgena = () => {
  ...
  const [inventory_do, setinventory_do] = useState("");
  const [validationError, setValidationError] = useState(false);
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(process.env.REACT_APP_API_URL+"/commerce/access-finance-inventory-list/upc/");
  ...
  const columns = [
    ...
    { field: "Qp", headerName: "035ml Q", flex: 1 },  
    { field: "Q_CASH", headerName: "0.35ml CASH", flex: 1 },    
    { field: "Hp", headerName: "0.6 ml Q", flex: 1 },   
    { field: "H_CASH", headerName: "0.6 CASH", flex: 1 },
 ...
 const handleApprove = async (id) => {
    ...
    try {
      ...
      formData.append("inventory_ddo", inventory_do);
      ...
      if (selectedRow) {
        ...
        const response = await fetch(`${process.env.REACT_APP_API_URL}/commerce/create-finance-inventory-form-Agena/${id}/`,
          {
            method: "PUT",
            body: formData,
          }
        ...
        <TableCell component="th" scope="row">
          ...
          <TableCell>{selectedRow.Total_CASH}(Value)</TableCell>
                  ...
                  <TableRow>
                      ...
                      <TableCell>{selectedRow.plate_no}</TableCell>
                      <TableCell>{selectedRow.T}</TableCell>
                      <TableCell>{selectedRow.T}</TableCell>
                  </TableRow>
...
<TableCell>
      ...
      <span style={{ color: 'red' }}>Inventory Recipant value is required</span>
            ...
            <TableCell>
              <input
                type="text"
                placeholder="ISIV No/Do No"
                value={inventory_do} 
                onChange={(e) => setinventory_do(e.target.value)} 
                // Add your input field logic here
                style={{
                  // Add your styling properties here
                  border: '1px solid black',
...
export default InventoryReturnAgena;  
