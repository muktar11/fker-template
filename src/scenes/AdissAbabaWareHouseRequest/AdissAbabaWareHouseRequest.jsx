...
const AdissAbabaWareHouseRequest = () => {
  ...
  const handleApprove = async (id) => {
    ...
    try {
      ...
      toast.success("Material Request Has Been Approved Successful ");
      handleUpdateClick()
      handleCloseModal()
  ...
  return (
    <Box m="20px">
      <Header title="Incoming Request AdissAbaba" subtitle="List of Orders that requires processing" />
      <ToastContainer />
      <Box
        m=" 0 0 0"
        height="100vh"
...
export default AdissAbabaWareHouseRequest;
