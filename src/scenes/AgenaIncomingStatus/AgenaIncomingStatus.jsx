...
const  AgenaIncomingRequest = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(process.env.REACT_APP_API_URL+"/commerce/status-rawmtaerial/Agena/");
  ...
  return (
    <Box m="20px">
      <Header title="Request Status Agena" subtitle="List of Orders that requires processing" />
      <ToastContainer />
      <Box
        m=" 0 0 0"
        height="100vh"
