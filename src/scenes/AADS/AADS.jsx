...
const AADS = () => {
  ...
  const [filters, setFilters] = useState({
    SalesPerson: "",  // Update this field to match backend parameter
    Plate_number:"",
    sales_route: "",
    Totalp: "",
    Total_CASH: "",
  ...
  useEffect(() => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_API_URL}/commerce/filtered-aads-sales-orders/?${queryParams.toString()}`);
      const data = await response.json();
  ...
  const columns = [
    ...
    { field: "sales_Route", headerName: "Route", flex: 1 },
     { field: "Qp", headerName: "0.35ml Qty", flex: 0.7 },  
    { field: "Q_CASH", headerName: "O.35mlVal", flex: 0.7 },    
    { field: "Hp", headerName: "0.6ml Qty", flex: 0.7 },   
    { field: "H_CASH", headerName: "0.6mlVal", flex: 0.7 },
    { field: "ONEp", headerName: "1L Qty", flex: 0.7 },   
    { field: "ONE_CASH", headerName: "1L Val", flex: 0.7 },
    { field: "TWOp", headerName: "2L Qty", flex: 0.7 },   
    { field: "TWO_CASH", headerName: "2L Val", flex: 0.7 },  
    { field: "Totalp", headerName: "Total Qty", flex: 0.7 },   
    { field: "Total_CASH", headerName: "Total Val", flex: 0.7 },  
  ...
  return (
    <Box m="20px">
      <ToastContainer />
      <Header
        title=" AADS Sales Summary"
        subtitle="List of direct sale orders"
      />
       <Box mb={2}>
        <TextField
          label="SalesPerson"
    ...
    marginRight: '10px',
    border: '2px solid',
    borderColor: 'white' // You can change the color as needed
  }}
        />
        <TextField
          label="Sales Route"
  ...
  {selectedRow && (
   ...
   <div class="table-row" style={{ display:"table-row"}}>
     ...
     <div class="table-cell" style={{ display: "table-cell", padding: "8px", border:"1px solid black"}}>{selectedRow?.inventory_return_forms[0]?.sales_Route_price?.Q}</div>
   ...
   <div class="table-row" style={{ display: "table-row"}}>
     ...
     <div class="table-cell" style={{ display: "table-cell", padding: "8px", border:"1px solid black"}}>{selectedRow?.inventory_return_forms[0]?.sales_Route_price?.ONE}</div>
   ...
   <div class="table-row" style={{ display: "table-row"}}>
     ...
     <div class="table-cell" style={{ display: "table-cell", padding: "8px", border:"1px solid black"}}>{selectedRow?.inventory_return_forms[0]?.sales_Route_price?.TWO}</div>
