...
overflow="hidden">
      ...
      <div className="main-print" style={{margRight:"10px", padding:"10px", paddingLeft:"5px", paddingRight:"5px"}}>
      ...
      <div className="header" style={{padding:"10px", justifyContent:"space-between", display:"flex", height:"100px", background:"#ffff"}}>
        ...
        <span onClick={printInvoice} style={{  color: "black", borderRadius: "4px", cursor: "pointer", marginRight: "10px" }}>
  Print
</span>
      </div>
      ...
      <div className="body-title" style={{ textAlign: "center", marginTop:"10px"  }}>       
        <h2>Customer Annually AdissAbaba and UPC SalesReport</h2>
      </div>
    
) : (
    <div className="body-title" style={{ textAlign: "center", marginTop:"10px"  }}>    
       <h2>SalesPerson Annually AdissAbaba and UPC SalesReport</h2>
    </div>
)}
 ...
 <div class="table-container" style={{ display:"table", width:"100%", marginTop:"10px" }}>
    <div class="table-row table-header" style={{display: "table-row" }}>
      ...
      <div class="table-cell" style={{display: "table-cell", padding: "2px", border:"1px solid black", width: "5%" }}>Route</div>
      <div class="table-cell" style={{display: "table-cell", padding: "2px", border:"1px solid black", width: "5%" }}>Plate</div>
      <div class="table-cell" style={{display: "table-cell", padding: "2px", border:"1px solid black", width: "2%"  }}>0.35mlQty</div>
      <div class="table-cell" style={{display: "table-cell", padding: "2px", border:"1px solid black", width: "2%"  }}>0.6mlQty</div>
      <div class="table-cell" style={{display: "table-cell", padding: "2px", border:"1px solid black", width: "2%"  }}>1LQty</div>
      <div class="table-cell" style={{display: "table-cell", padding: "2px", border:"1px solid black", width: "2%"  }}>2LQty</div>
      <div class="table-cell" style={{display: "table-cell", padding: "2px", border:"1px solid black", width: "2%" }}>0.35mlUP</div>
      <div class="table-cell" style={{display: "table-cell", padding: "2px", border:"1px solid black", width: "2%" }}>0.6mlUP</div>
      <div class="table-cell" style={{display: "table-cell", padding: "2px", border:"1px solid black", width: "2%" }}>1LUP</div>
      <div class="table-cell" style={{display: "table-cell", padding: "2px", border:"1px solid black", width: "2%" }}>2LUP</div>
      <div class="table-cell" style={{display: "table-cell", padding: "2px", border:"1px solid black", width: "2%" }}>0.35mlVal</div>
      <div class="table-cell" style={{display: "table-cell", padding: "2px", border:"1px solid black", width: "2%" }}>0.6mlVal</div>
      <div class="table-cell" style={{display: "table-cell", padding: "2px", border:"1px solid black", width: "2%" }}>1LtVal</div>
      <div class="table-cell" style={{display: "table-cell", padding: "2px", border:"1px solid black", width: "2%" }}>2LtVal</div>
      <div class="table-cell" style={{display: "table-cell", padding: "2px", border:"1px solid black", width:"3%" }}>TotalPrice</div>
      <div class="table-cell" style={{display: "table-cell", padding: "2px", border:"1px solid black", width:"3%" }}>TotalQty</div>
      <div class="table-cell" style={{display: "table-cell", padding: "2px", border:"1px solid black", width:"3%"}}>Performance</div>
      <div class="table-cell" style={{display: "table-cell", padding: "2px", border:"1px solid black", width:"3%"}}>ExecutionTime</div>
    </div>
    {itemsForCurrentPage.map((order, index) => (
       ...
       <div className="table-cell" style={{ display: "table-cell", padding: "2px", border: "1px solid black", width: "5%" }}>{order.plate_no}</div>
       ...
       <div className="table-cell" style={{ display: "table-cell", padding: "2px", border: "1px solid black", width: "2%" }}>{order.agent_sales_performance?.daily_sales_performance_qty_achievement}%</div>
       <div className="table-cell" style={{ display: "table-cell", padding: "2px", border: "1px solid black", width: "2%" }}>{order.time_gap_inventory_created}</div>
     </div>
    ))}
  </div>
) : (
  ...
  <div class="table-container" style={{ display:"table", width:"100%", marginTop:"10px" }}>
    <div class="table-row table-header" style={{display: "table-row" }}>
      ...
      <div class="table-cell" style={{display: "table-cell", padding: "5px", border:"1px solid black", width: "5%" }}>Plate </div>
      <div class="table-cell" style={{display: "table-cell", padding: "5px", border:"1px solid black", width: "2%"  }}>0.35mlQty</div>
      <div class="table-cell" style={{display: "table-cell", padding: "5px", border:"1px solid black", width: "2%"  }}>0.6mlQty</div>
      <div class="table-cell" style={{display: "table-cell", padding: "5px", border:"1px solid black", width: "2%"  }}>1LQty</div>
      <div class="table-cell" style={{display: "table-cell", padding: "5px", border:"1px solid black", width: "2%"  }}>2LQty</div>
      <div class="table-cell" style={{display: "table-cell", padding: "5px", border:"1px solid black", width: "2%" }}>0.35mlUP</div>
      <div class="table-cell" style={{display: "table-cell", padding: "5px", border:"1px solid black", width: "2%" }}>0.6mlUP</div>
      <div class="table-cell" style={{display: "table-cell", padding: "5px", border:"1px solid black", width: "2%" }}>1LUP</div>
      <div class="table-cell" style={{display: "table-cell", padding: "5px", border:"1px solid black", width: "2%" }}>2LUP</div>
      <div class="table-cell" style={{display: "table-cell", padding: "5px", border:"1px solid black", width: "2%" }}>0.35mlVal</div>
      <div class="table-cell" style={{display: "table-cell", padding: "5px", border:"1px solid black", width: "2%" }}>0.6mlVal</div>
      <div class="table-cell" style={{display: "table-cell", padding: "5px", border:"1px solid black", width: "2%" }}>1LVal</div>
      <div class="table-cell" style={{display: "table-cell", padding: "5px", border:"1px solid black", width: "2%" }}>2LVal</div>
      <div class="table-cell" style={{display: "table-cell", padding: "5px", border:"1px solid black", width:"3%" }}>TotalPrice</div>
      <div class="table-cell" style={{display: "table-cell", padding: "5px", border:"1px solid black", width:"3%" }}>TotalQty</div>
