...
const ProductionWareHouseRequest = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(process.env.REACT_APP_API_URL+"/commerce/access-rawmtaerial/Factory/");
  ...
  const handleApprove = async (id) => {
    ...
    try {
      ...
      toast.success("Production Request Has been Approved");
      handleUpdateClick()
      handleCloseModal()
  ...
  return (
    <Box m="20px">
      <Header title="Incoming Request Production" subtitle="List of Orders that requires processing" />
      <ToastContainer />
      <Box
        m=" 0 0 0"
        height="100vh"
...
export default ProductionWareHouseRequest;
