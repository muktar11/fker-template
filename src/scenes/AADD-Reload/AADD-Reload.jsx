...
const AADDReload = () => {
  ...
  useEffect(() => {
    if (salesRoute) {
      ...
      fetch(process.env.REACT_APP_API_URL+`/commerce/get-latest-price/${salesRoute}/AdissAbaba/`)
...
const handleApprove = async (id) => {
  ...
  body: JSON.stringify({
    ...
    const data = await response.json();
     ...
     console.log("Reload has successfully Registered:", data);
    ...
    <TableBody>
      ...
      <TableRow>
        ...
        <TableCell>
            ...
            {selectedRow.inventory_ddo}</TableCell>
