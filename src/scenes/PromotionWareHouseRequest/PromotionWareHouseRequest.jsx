...
const PromotionWareHouseRequest = () => {
  ...
  return (
    <Box m="20px">
      <Header title="Incoming Request Promotion" subtitle="List of Orders that requires processing" />
      <ToastContainer />
      <Box
        m=" 0 0 0"
        height="100vh"
...
export default PromotionWareHouseRequest;
