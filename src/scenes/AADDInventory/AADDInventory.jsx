...
const AADDInventoryReturn = () => {
  ...
  const [inventory_ddo, setinventory_ddo] = useState("");
  const [reload_ddo, setreload_ddo] = useState(null);
  ...
  const handleApprove = async (id) => {
    try {
      ...
      formData.append("inventory_ddo", inventory_ddo);
      ...
      if (selectedRow) {
        ...
        if (inventory_ddo.trim() === '') {
          // CSI CSRI value is required, display an error message or perform any necessary action
          toast.error("inventory DDO is required");
          return;
        }
...
const handleReload = async (id) => {
  try {
    ...
    formData.append("reload_ddo", reload_ddo);
    ...
    <TableContainer component={Paper}>
      ...
      <Table sx={{}} size="small" aria-label="a dense table">
        ...
        <TableBody>
          ...
          <TableRow>
            ...
            <TableCell>{selectedRow.inventory_recipant}</TableCell>
            <TableCell>{selectedRow.Total_CAS}</TableCell>
            <TableCell>{selectedRow.T}</TableCell>
          </TableRow>
          ...
          <TableRow>
            ...
            <TableCell>{selectedRow.inventory_ddo}</TableCell>
            <TableCell>{selectedRow.Total_CAS}</TableCell>
            <TableCell>{selectedRow.T}</TableCell>
          </TableRow>
          <TableRow>
      ...
      <span style={{ color: 'red' }}>Inventory Recipant value is required</span>
            ...
            <TableCell>
              <input
                type="text"
                placeholder="R/C/S No"
                value={inventory_ddo}
                onChange={(e) => setinventory_ddo(e.target.value)} 
                style={{
                  border: '1px solid black',
                  padding: '8px',
                  borderRadius: '4px',
              ...
              />
               {validationError && (
      <span style={{ color: 'red' }}>Inventory DDO is required</span>
    )}
            </TableCell>  
    ...
    <TableRow>
      ...
      <TableCell>
        <input
          ...
          placeholder="R/C/S No"
          value={reload_ddo}
          onChange={(e) => setreload_ddo(e.target.value)} 
          style={{
            border: '1px solid black',
            padding: '8px',
            borderRadius: '4px',
