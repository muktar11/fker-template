  ...
  const handleFormSubmit = async (values, { resetForm }) => {
    try {
      const response = await fetch(
        process.env.REACT_APP_API_URL + "/commerce/sales-person/create/",
        {
          method: "POST",
          headers: {
      ...
      if (response.ok) {
        ...
        resetForm(); // Reset Formik's form state
      } else {
  ...
  return (
    <Box m="20px">
      ...
      <Formik
        ...
        initialValues={initialFormValues} // Using the updated initialFormValues
      ...
      >
        {({
          ...
          handleChange,
          handleSubmit,
          resetForm, // To manually reset form if needed
        }) => (
