...
const ProductionWareHouseStatus = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(process.env.REACT_APP_API_URL+"/commerce/status-rawmtaerial/Factory/");
  ...
  const handleUpdateClick = async () => {
    try {
      const response = await (process.env.REACT_APP_API_URL+"/commerce/status-rawmtaerial/Factory/");
      const data = await response.json();
      setCustomerData(data);
...
export default  ProductionWareHouseStatus;
