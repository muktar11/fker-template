...
useEffect(() => {
  ...
  setTotalp('');
  setTotalCash('');
}, [salesRoute, selectedWarehouse]); // Include all relevant state setters in the dependency array
...
useEffect(() => {
  ...
  const grand_totalCash = parseInt(Q_CASH || 0) + parseInt(H_CASH || 0) + parseInt(ONE_CASH || 0) + parseInt(TWO_CASH || 0) + parseInt(TransportationFee || 0);
