...
<div style={{ textAlign: 'center', padding: '10px' }}>
  ...
  <TableHead>
    ...
    <TableBody>
      ...
      <TableRow>
        ...
        inventory Reload
          ...
          <TableCell>
            ...
            {selectedRow.reload[0]?.reload_recipient}</TableCell>
            <TableCell>{selectedRow.T}</TableCell>
             <TableCell>{selectedRow.T}</TableCell>
      </TableRow>
      ...
      <TableRow>
        <TableCell component="th" scope="row">
        inventory Reload R/C/S/ No
        </TableCell>      
          <TableCell>         
          {selectedRow.reload[0]?.inventory_ddo}
           </TableCell>
           <TableCell>{selectedRow.T}</TableCell>
           <TableCell>{selectedRow.T}</TableCell>
      </TableRow>
...
<TableRow>
  ...
  <TableCell>
    <input
      ...
      placeholder="RCSNO"
      value={RCSNO}
      onChange={(e) => setRCSNO(e.target.value)}
      // Add your input field logic here
      style={{
        // Add your styling properties here
        border: '1px solid black',
