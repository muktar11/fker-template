...
const  FactoryWareHouseStatus = () => {
  ...
  const handleUpdateClick = async () => {
    try {
      const response = await fetch(process.env.REACT_APP_API_URL+"/commerce/status-rawmtaerial/AdissAbaba/");
      const data = await response.json();
      setCustomerData(data);
...
export default  FactoryWareHouseStatus;
