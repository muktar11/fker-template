...
const  AgenaIncomingRequest = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(process.env.REACT_APP_API_URL+"/commerce/access-rawmtaerial/Agena/");
  ...
  return (
    <Box m="20px">
      <Header title="Agena Incoming Request" subtitle="List of Orders that requires processing" />
      <ToastContainer />
      <Box
        m=" 0 0 0"
        height="100vh"
...
export default AgenaIncomingRequest;
